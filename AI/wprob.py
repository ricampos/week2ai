...
# READ DATA
def read_data(wlist,station,ltime1,ltime2):
    ...
    gefsdata = {'cdate': cdate,'ctime': ctime, 'ensm': ensm, 'latm': latm, 'lonm': lonm,
        'indlat': indlat, 'indlon': indlon, 'indt': indt,
        'u10_ndbc': u10_ndbc, 'hs_ndbc': hs_ndbc,
        'u10_gefs_hindcast': u10_gefs_hindcast, 'hs_gefs_hindcast': hs_gefs_hindcast,
        'u10_gefs_forecast': u10_gefs_forecast, 'hs_gefs_forecast': hs_gefs_forecast}
...
def crps(fmod,obs,cdate,ftag):
    ...
    ax.plot(cdate, obs/np.nanmax(obs), color='dimgrey', marker='.', linestyle='', linewidth=2., label='Obs (normalized)', zorder=2)
